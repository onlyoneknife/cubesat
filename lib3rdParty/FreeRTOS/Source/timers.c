...
#else
{
	...
	xReturn =
			xTaskCreate( prvTimerTask, "Tmr Svc", ( uint16_t ) configTIMER_TASK_STACK_DEPTH, NULL, ( ( UBaseType_t ) configTIMER_TASK_PRIORITY ) | portPRIVILEGE_BIT, NULL);
}
#endif
} else {
...
void * const pvTimerID, TimerCallbackFunction_t pxCallbackFunction) /*lint !e971 Unqualified char types are allowed for strings and single characters only. */
{
Timer_t *pxNewTimer;
...
BaseType_t xTimerIsTimerActive(TimerHandle_t xTimer) {
	...
	/* Is the timer in the list of active timers? */taskENTER_CRITICAL();
	{

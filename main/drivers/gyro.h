...
typedef enum {
  GYRO_SPI_4_WIRE                     =               0x00,
  GYRO_SPI_3_WIRE                     =               0x01
} GYRO_SPIMode_t;
...
#define GYRO_INT1_SEL1                               BIT(3)
#define GYRO_INT1_SEL0                               BIT(2)
...
#define GYRO_INT1_AND                                0x80
#define GYRO_INT1_OR                                 0x00
#define GYRO_INT1_LIR_ENABLE                         0x40
#define GYRO_INT1_LIR_DISABLE                        0x00
#define GYRO_INT1_ZHIE_ENABLE                        0x20
#define GYRO_INT1_ZHIE_DISABLE                       0x00
#define GYRO_INT1_ZLIE_ENABLE                        0x10
#define GYRO_INT1_ZLIE_DISABLE                       0x00
#define GYRO_INT1_YHIE_ENABLE                        0x08
#define GYRO_INT1_YHIE_DISABLE                       0x00
#define GYRO_INT1_YLIE_ENABLE                        0x04
#define GYRO_INT1_YLIE_DISABLE                       0x00
#define GYRO_INT1_XHIE_ENABLE                        0x02
#define GYRO_INT1_XHIE_DISABLE                       0x00
#define GYRO_INT1_XLIE_ENABLE                        0x01
#define GYRO_INT1_XLIE_DISABLE                       0x00
...
#define GYRO_STATUS_REG_ZYXOR                        0x07    // 1	:	new data set has over written the previous one
							// 0	:	no overrun has occurred (default)	
#define GYRO_STATUS_REG_ZOR                          0x06    // 0	:	no overrun has occurred (default)
							// 1	:	new Z-axis data has over written the previous one
#define GYRO_STATUS_REG_YOR                          0x05    // 0	:	no overrun has occurred (default)
							// 1	:	new Y-axis data has over written the previous one
#define GYRO_STATUS_REG_XOR                          0x04    // 0	:	no overrun has occurred (default)
							// 1	:	new X-axis data has over written the previous one
#define GYRO_STATUS_REG_ZYXDA                        0x03    // 0	:	a new set of data is not yet avvious one
                                                        // 1	:	a new set of data is available 
#define GYRO_STATUS_REG_ZDA                          0x02    // 0	:	a new data for the Z-Axis is not availvious one
                                                        // 1	:	a new data for the Z-Axis is available
#define GYRO_STATUS_REG_YDA                          0x01    // 0	:	a new data for the Y-Axis is not available
                                                        // 1	:	a new data for the Y-Axis is available
#define STATUS_REG_XDA                         			0x00    // 0	:	a new data for the X-Axis is not available

#define GYRO_DATAREADY_BIT                           GYRO_STATUS_REG_ZYXDA

#define GYRO_I_AM_L3GD20H			        0xD4
...
status_t GYRO_SetHPFCutOFF(GYRO_HPFCutOffFreq_t hpf);status_t GYRO_HPFEnable(State_t hpf);
